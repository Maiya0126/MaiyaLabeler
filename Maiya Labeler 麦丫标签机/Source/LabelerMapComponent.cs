...
namespace MaiyaLabeler
{
    ...
    {
        // ... 之前的 Dictionary, GUIStyle, 构造函数保持不变 ...
        ...
        public override void MapComponentUpdate()
        {
            ...
            if (DefDatabase<KeyBindingDef>.GetNamed("MaiyaLabeler_OpenConfig").KeyDownEvent) OpenConfigWindowAt(UI.MouseCell());
        ...
        public static void OpenConfigWindowAt(IntVec3 c)
        {
            ...
            {
                // 使用翻译Key: MaiyaLabeler_Msg_IsDoor
